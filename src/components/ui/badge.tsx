  ...
  'web:inline-flex items-center rounded-full border border-border px-2.5 py-0.5 web:transition-colors web:focus:outline-none web:focus:ring-2 web:focus:ring-ring web:focus:ring-offset-2',
  {
    variants: {
      variant: {
        ...
        secondary: 'border-transparent bg-secondary dark:bg-secondary-dark web:hover:opacity-80 active:opacity-80',
...
const badgeTextVariants = cva('text-xs font-semibold ', {
  variants: {
    variant: {
      default: 'text-primary-foreground dark:text-primary-foregroundDark',
      secondary: 'text-secondary-foreground dark:text-white',
      destructive: 'text-destructive-foreground dark:text-destructive-foregroundDark',
      outline: 'text-foreground dark:text-foregroundDark',
    },
  },
  defaultVariants: {
    variant: 'default',
